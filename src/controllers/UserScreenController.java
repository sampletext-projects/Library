...
public class UserScreenController implements FXMLHelper.PreloadableController, FXMLHelper.NotifiableController {
    ...
    private BookStorage userStorage;
    ...
    public final <T> void onNotify(T... objects) {
        ...
        if ("Update".equals(command)) {
            ...
            userStorage = Database.getBookStoragesDb().getByUserId(User.activeUser.getId());
    ...
    public void onButtonMyBooksClick(ActionEvent actionEvent) {
    ...
    public void onButtonTakeBookClick(ActionEvent actionEvent) {
